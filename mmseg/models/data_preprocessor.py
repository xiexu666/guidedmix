...
class SegDataPreProcessor(BaseDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> Dict[str, Any]:
        ...
        if 'unsup.inputs' in data:
            unsup_inputs = data['unsup.inputs']
            inputs.extend(unsup_inputs)
            unsup_data_samples = data.get('unsup.data_samples', None)
            data_samples.extend(unsup_data_samples)
